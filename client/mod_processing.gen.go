...
type ProcessingEvent struct {
	EnumTypeValue interface{} // any of WillFetchFirstBlockProcessingEvent, FetchFirstBlockFailedProcessingEvent, WillSendProcessingEvent, DidSendProcessingEvent, SendFailedProcessingEvent, WillFetchNextBlockProcessingEvent, FetchNextBlockFailedProcessingEvent, MessageExpiredProcessingEvent,
}
