...
func init() { // nolint gochecknoinits
	errorCodesToErrorTypes[InvalidDataProofsErrorCode] = "InvalidDataProofsErrorCode"
	errorCodesToErrorTypes[ProofCheckFailedProofsErrorCode] = "ProofCheckFailedProofsErrorCode"
	errorCodesToErrorTypes[InternalErrorProofsErrorCode] = "InternalErrorProofsErrorCode"
	errorCodesToErrorTypes[DataDiffersFromProvenProofsErrorCode] = "DataDiffersFromProvenProofsErrorCode"
}
...
func (c *Client) ProofsProofBlockData(p *ParamsOfProofBlockData) error {
	_, err := c.dllClient.waitErrorOrResult("proofs.proof_block_data", p)
...
func (c *Client) ProofsProofTransactionData(p *ParamsOfProofTransactionData) error {
	_, err := c.dllClient.waitErrorOrResult("proofs.proof_transaction_data", p)
...
func (c *Client) ProofsProofMessageData(p *ParamsOfProofMessageData) error {
	_, err := c.dllClient.waitErrorOrResult("proofs.proof_message_data", p)
